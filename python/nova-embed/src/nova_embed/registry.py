...
Each pluggable component — sources, dense/sparse/multivector embedders — declares
...
DENSE_EMBEDDERS: "Registry[DenseEmbedder]" = Registry("dense embedder")
SPARSE_EMBEDDERS: "Registry[SparseEmbedder]" = Registry("sparse embedder")
MULTIVECTOR_EMBEDDERS: "Registry[MultiVectorEmbedder]" = Registry("multivector embedder")
