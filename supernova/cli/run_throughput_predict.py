#!/usr/bin/env python3
"""
Predict embedding throughput and cost for a supernova embedder config.
...
from supernova.throughput import GPU_TABLE, run_prediction
...
def throughput_predict(
    ...
    """Predict embedding throughput and cost from a supernova embedder config."""
    logging.basicConfig(
